...
class User(db.Model, UserMixin):
    ...
    email = db.Column(
        db.Unicode(255), nullable=False, server_default=u'', unique=True)
    ...
    first_name = db.Column(
        db.Unicode(50), nullable=False, server_default=u'')
    last_name = db.Column(
        db.Unicode(50), nullable=False, server_default=u'')
...
class Role(db.Model):
    ...
    label = db.Column(
        db.Unicode(255), server_default=u'')  # for display purposes
